"""
Django settings for stockplant project.
...
DEBUG = os.getenv('DEBUG', 'True').lower() in ('1', 'true', 't', 'yes')
...
WSGI_APPLICATION = 'stockplant.wsgi.application'
...
if _DB_URL:
    ...
    _DB_SCHEMA = os.getenv('DB_SCHEMA', 'public')
    if DATABASES['default'].get('ENGINE') == 'django.db.backends.postgresql':
        DATABASES['default'].setdefault('OPTIONS', {})['options'] = f"-c search_path={_DB_SCHEMA}"
else:
    DATABASES = {
        'default': {
